...
private:
    ...
    void initializeQuests() {
        ...
        mainQuest.addObjective("Hack the terminal", 1);
        mainQuest.addObjective("Defeat security", 1);
    ...
    bool checkWinCondition() {
        return player->hasQuestFlag("terminal_hacked") && 
               player->hasQuestFlag("security_defeated") && 
               player->hasQuestFlag("airlock_escaped");
    }
